...
import './EdificiosIndustrialesC.css';

const EdificiosIndustrialesC = ({ onBack }) => {
  // Constantes
  const VPTR = 1250;
  ...
  // Función para calcular el valor según los tramos de m2 específicos para edificios industriales
  const calcularPorTramos = (m2) => {
    let total = 0;
    
    // Primeros 1000m² al 40%
    const tramo1 = Math.min(m2, 1000);
    total += tramo1 * VPTR * 0.4;
    
    // Resto al 20%
    if (m2 > 1000) {
      const tramo2 = m2 - 1000;
      total += tramo2 * VPTR * 0.2;
    }
  ...
  return (
    <Container fluid className="industriales-container">
      {/* Imagen superior */}
      <div className="card-media-container image-container mb-4">
        <img 
          ...
          onError={(e) => {
            ...
            e.target.src = '/images/edificios_industriales.jpg';
          }}
        />
      </div>
      ...
      <div className="text-center mb-4">
        <h2 className="main-title">Edificios Industriales</h2>
              ...
              <div className="mb-3 dynamic-field" id="tareasEdificioField">
                ...
                <div className="form-check task-item">
                  <input 
                    ...
                    type="radio" 
                    name="tareaEdificioIndustrial" 
                    id="iAnteproyecto" 
                    value="Anteproyecto" 
                    checked={tareaSeleccionada === "Anteproyecto"}
                    onChange={() => setTareaSeleccionada("Anteproyecto")}
                  />
                  <label className="form-check-label" htmlFor="iAnteproyecto">Anteproyecto</label>
                </div>
                <div className="form-check task-item">
                  <input 
                    className="form-check-input" 
                  ...
                  />
                  <label className="form-check-label" htmlFor="iProyecto">Proyecto</label>
                </div>
                <div className="form-check task-item">
                  <input 
                    className="form-check-input" 
                  ...
                  />
                  <label className="form-check-label" htmlFor="iDireccion">Dirección Técnica</label>
                </div>
                <div className="form-check task-item">
                  <input 
                    className="form-check-input" 
                  ...
                  />
                  <label className="form-check-label" htmlFor="iAnteproyectoProyecto">Anteproyecto y Proyecto</label>
                </div>
                <div className="form-check task-item">
                  <input 
                    className="form-check-input" 
                  ...
                  />
                  <label className="form-check-label" htmlFor="iProyectoDireccion">Proyecto y Dirección Técnica</label>
                </div>
                <div className="form-check task-item">
                  <input 
                    className="form-check-input" 
                  ...
                  />
                  <label className="form-check-label" htmlFor="iCompleto">Anteproyecto, Proyecto y Dirección Técnica</label>
                </div>
              </div>
            )}
      ...
      <div className="resultado-card mt-4">
        <h4 className="text-center">Resultados - Edificios Industriales</h4>
        {resultados ? (
          resultados.error ? (
...
export default EdificiosIndustrialesC;