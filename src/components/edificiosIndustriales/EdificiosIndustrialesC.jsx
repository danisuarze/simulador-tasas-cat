...
import './EdificiosIndustriales.css';
...
const EdificiosIndustrialesC = ({ onBack }) => {
  ...
  // MODIFICACIÓN: Primeros 1000m² al 40% y el resto al 20%
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="card">
              <div className="card-header">
                <h5 className="mb-0">Edificios Industriales</h5>
              </div>
          ...
          <div className="col-lg-6">
            <div className="card result-card">
              <div className="card-header">
                <h5 className="mb-0">Resultados - Edificios Industriales</h5>
              </div>
              <div className="card-body">
                {resultados ? (
                  resultados.error ? (
